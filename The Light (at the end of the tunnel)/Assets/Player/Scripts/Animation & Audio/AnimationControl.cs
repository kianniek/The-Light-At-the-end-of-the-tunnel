...
public class AnimationControl : MonoBehaviour
{
    ...
    [SerializeField] float speedToAnimationRatio = 5;
    ...
    void Update()
    {
        //Get Movement Speed of controller to set the animation speed
        animator.speed = controller.GetMaxVelocity() / speedToAnimationRatio;

        //Get controller velocity;
        Vector3 _velocity = controller.GetVelocity() * multiplier;
